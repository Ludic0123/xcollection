...
export default async function SpotsPage({
  ...
  let query = supabase.from('spots').select('*').not('name', 'like', TEST_CONTENT_PATTERN).order('created_at', { ascending: false })
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <form className="px-4 md:px-16 py-2.5 md:py-5 border-b hairline flex flex-wrap gap-3 md:gap-4 items-end">
        ...
        <div>
          <p className="text-xs tracking-luxe text-neutral-600 mb-0.5">CATEGORY</p>
          <select
            name="category"
        ...
        <div>
          <p className="text-xs tracking-luxe text-neutral-600 mb-0.5">CITY</p>
          <select
            name="city"
