        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-neutral-50 border-b hairline">
              <th className="py-2 px-3 text-left text-xs tracking-luxe text-neutral-500">タイトル</th>
              <th className="py-2 px-3 text-left text-xs tracking-luxe text-neutral-500">タイプ</th>
              <th className="py-2 px-3 text-left text-xs tracking-luxe text-neutral-500">日程</th>
              <th className="py-2 px-3 text-left text-xs tracking-luxe text-neutral-500">ステータス</th>
              <th></th>
            </tr>
          </thead>
          <tbody>
