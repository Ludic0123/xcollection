        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-neutral-50 border-b hairline">
              <th className="py-2 px-3 text-left text-xs tracking-luxe text-neutral-500">名前</th>
              <th className="py-2 px-3 text-left text-xs tracking-luxe text-neutral-500">ブランド</th>
              <th className="py-2 px-3 text-left text-xs tracking-luxe text-neutral-500">都道府県</th>
