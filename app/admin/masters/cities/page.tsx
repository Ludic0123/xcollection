...
export default async function CitiesAdminPage() {
  ...
  return (
    <div className="px-4 py-6 md:px-10 md:py-10">
      ...
      <h1 className="font-serif text-4xl italic font-light mt-1 mb-6">Cities.</h1>
      <p className="text-sm text-neutral-500 mb-6">街・エリアの選択肢。</p>
      <MasterTable
        tableName="master_cities"
        fields={[
          { key: 'name', label: '名前', required: true, placeholder: '京都 / 東京 / 那覇' },
